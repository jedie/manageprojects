...
def main(argv):
    ...
    if not PYTHON_PATH.is_file() or force_update:
        ...
        verbose_check_call(PYTHON_PATH, '-m', 'pip', 'install', '-r', str(DEP_LOCK_PATH))
